...
<html>
    ...
    <meta charset="utf-8">
        ...
        <title>Lab 7 - Update Project</title>
        <style type="text/css">
            body {
    ...
    <body>
        ...
        <!-- Update project in ProjectTable -->
        
        <form id="form" name="form" method="post" action="doUpdateProject.php">
            <fieldset>
                <legend>Update the Assign06Projects table</legend>
                <ul>
                    <li class="text-group">
