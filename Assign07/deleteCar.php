...
<html>
    ...
    <body>
        ...
        <!-- Delete car in CarsTable -->
        
        <form id="form" name="form" method="post" action="doDeleteCar.php">
            <fieldset>
                <legend>Delete Car from Assign06Cars table</legend>
                <ul>
                    <li class="text-group">
                    ...
                    <li class="select-group">
                        ...
                        <select name="carMakeDis" id="carMakeDis" disabled>
                            <?php
                            $makes = [
                    ...
                    <li class="text-group">
                        ...
                        <input name="carModelDis" id="carModelDis" type="text" size="30" maxlength="50" disabled
                    ...
                    <li class="select-group">
                        ...
                        <select name="carYearDis" id="carYearDis" disabled>
                            <?php
                        ...
                        <input type="hidden" name="carYear" value="<?php echo $row["CarYear"]; ?>" />
                    </li>
                    <li class="text-group">
                        <label title="carColor" for="carColor">Color <span>*</span></label>
                        <input name="carColorDis" id="carColorDis" type="text" size="30" maxlength="50" disabled
                            value="<?php if ($num_results != 0) { echo trim($row["CarColor"]); } ?>" />
                        <input type="hidden" name="carColor" value="<?php echo $row["CarColor"]; ?>" />
                    </li>
                    <li class="radio-group">
                        <label title="carHybrid" for="carHybrid">Hybrid? <span>*</span></label>
                        <div class="radio-opts">
                            <label title="carHybridYes" for="yes">
                                <input type="radio" id="yes" name="carHybridDis" value="Yes" disabled
                                    <?php if ($num_results != 0 && $row["CarHybrid"] == "Yes") echo "checked"; ?> />Yes
                            </label>
                            <label title="carHybridNo" for="no">
                                <input type="radio" id="no" name="carHybridDis" value="No" disabled
                                    <?php if ($num_results != 0 && $row["CarHybrid"] == "No") echo "checked"; ?> />No
                            </label>
                        </div>
                        <input type="hidden" name="carHybrid" value="<?php echo $row["CarHybrid"]; ?>" />
                    </li>
                    <li class="err-group">
                        <span><?php echo($_SESSION["errorMessage"]); ?></span>
                    </li>
                    <li class="submit-group">
                        <input type="submit" value="Confirm Delete Car" name="submit" id="submit" />
                    </li>
                </ul>
            </fieldset>
        </form>
