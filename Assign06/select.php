...
<html>
    ...
    <body>
        ...
        <table title="Listing of Users" id="usersTable">
            <thead>
                <tr>
                    <th colspan="5" class="table-title">usersLab5 table</th>
                </tr>
                <tr>
                    <th>&nbsp</th>
                    <th>UserID</th>
            ...
            <tfoot>
                <tr>
                    <td colspan="5">Information pulled from usersLab5 table.</td>
                </tr>
            </tfoot>
            <tbody>
                <?php
        ...
        <table title="Listing of Shippers" id="shippersTable">
            <thead>
                <tr>
                    <th colspan="4" class="table-title">shippersLab5 table</th>
                </tr>
                <tr>
                    <th>&nbsp</th>
                    <th>ShipperID</th>
            ...
            <tfoot>
                <tr>
                    <td colspan="4">Information pulled from shippersLab5 table.</td>
                </tr>
            </tfoot>
            <tbody>
                <?php
